...
class PersonaForm(forms.ModelForm):
	class Meta:
			model = Persona
			fields = ('imagen','identificacion','nombres','apellidos','ficha', 'telefono',)		
...
class aprendicesForm(forms.ModelForm):
	class Meta:
		model = Persona
		fields = ('imagen','nombres', 'apellidos','ficha','telefono',)

class instructorForm(forms.ModelForm):
	class Meta:
		model = Persona
		fields = ('imagen','nombres', 'apellidos','telefono',)		
...
class solucion_reto_grupal(forms.ModelForm):
	class Meta: 
		model = Persona_Reto
		fields	 = [
		'descripcion',
